//Vars Starts
LessonDetails = "[CourseDetails]~CourseName,Algebra~LessonName,ABC to XYZ~TotalSection,8[Details_Split][Section1Details]~IR~L10RW01.swf[Details_Split][Section2Details]~RW~L10RW02.swf~L10RW03.swf~L10RW04.swf~L10RW05.swf[Details_Split][Section3Details]~VB~L10VB01.swf~L10VB02.swf~L10VB03.swf~L10VB04.swf~L10VB05.swf~L10VB06.swf~L10VB07.swf~L10VB08.swf~L10VB09.swf~L10VB10.swf~L10VB11.swf[Details_Split][Section4Details]~IN~L10IN01.swf~L10IN02.swf~L10IN03.swf~L10IN04.swf~L10IN05.swf~L10IN06.swf~L10IN07.swf~L10IN08.swf~L10IN09.swf~L10IN10.swf~L10IN11.swf~L10IN12.swf~L10IN13.swf~L10IN14.swf~L10IN15.swf~L10IN16.swf[Details_Split][Section5Details]~TI~L10TI01.swf~L10TI02.swf~L10TI03.swf~L10TI04.swf~L10TI05.swf~L10TI06.swf[Details_Split][Section6Details]~GS~L10GS01.swf~L10GS02.swf[Details_Split][Section7Details]~TS~L10TS01.swf~L10TS02.swf~L10TS03.swf~L10TS04.swf~L10TS05.swf~L10TS06.swf~L10TS07.swf~L10TS08.swf[Details_Split][Section8Details]~FQ~L10FQ01.swf~L10FQ02.swf~L10FQ03.swf";
SlideSpaceDetails = "[Section1Details]~IR[Details_Split][Section2Details]~RW[Details_Split][Section3Details]~VB~7[Details_Split][Section4Details]~IN~3~5~6~8~10~11~13[Details_Split][Section5Details]~TI[Details_Split][Section6Details]~GS[Details_Split][Section7Details]~TS[Details_Split][Section8Details]~FQ";
RandomAudioDetails = "[Section1Details]~IR~L10RW01.swf[Details_Split][Section2Details]~RW[Details_Split][Section3Details]~VB~L10VB01.swf[Details_Split][Section4Details]~IN~L10IN01.swf[Details_Split][Section5Details]~TI~L10TI01.swf[Details_Split][Section6Details]~GS~L10GS01.swf[Details_Split][Section7Details]~TS";
BGTextDetails = "[Section1Details]~IR~L10RW01.swf[Details_Split][Section2Details]~RW[Details_Split][Section3Details]~VB~L10VB01.swf[Details_Split][Section4Details]~IN~L10IN01.swf[Details_Split][Section5Details]~TI~L10TI01.swf[Details_Split][Section6Details]~GS~L10GS01.swf[Details_Split][Section7Details]~TS~L10TS01.swf";
//Vars End
...
function doCreateSlide() {
	...
	if (_global.sectionNumber == 3) {
		...
		slideName[2] = "Unit of Measurement";
				
		slideName[3] = "Length";	
		
		slideName[4] = "Width";
						
		slideName[5] = "Length/Width Practice";		
		slideName[6] = "Length/Width Practice";	
		
		slideName[7] = "Perimeter";
		
		slideName[8] = "Area";
				
		slideName[9] = "Square Unit";
		
		slideName[10] = "Formula";
	...
	if (_global.sectionNumber == 4) {
		...
		intSlideNum = 0;
				...
				slideName[1] = "Measure Length and Width";
				slideName[2] = "Measure Length and Width Practice";
				
				slideName[3] = "Perimeter";
				slideName[4] = "Perimeter Practice";
				slideName[5] = "Perimeter Practice";

				slideName[6] = "Perimeter of Other Shapes";				
				slideName[7] = "Perimeter of Other Shapes Practice";

				slideName[8] = "Area";				
				slideName[9] = "Area Practice";
				slideName[10] = "Area Practice";
				
				slideName[11] = "Area of Complex Shapes";				
				slideName[12] = "Area of Complex Shapes Practice";

				slideName[13] = "Same Perimeters, Different Areas";	
				
				slideName[14] = "Same Areas, Different Perimeters";	
				
				slideName[15] = "Same Area or Same Perimeter?";	
...
function doPlayPreviousMovie() {
	...
	if (_global.sectionNumber == 3) {
		if (_global.slideNumber<2) {
			...
			_global.playSwfFileName = _global.tempURL+"/RW/"+_global.arrSection3_Details[_global.slideNumber];
			_root.doCreateSlide();
			_root.doPutBackAndFinished();
			_root.loadSWFMovie();
		} else {
	...
	if (_root.dtfSPANISH.text == "ON") {
		if (_global.spanSound != true) {
			if (_global.sectionNumber == 2 || _global.sectionNumber == 3 || _global.sectionNumber == 4 || _global.sectionNumber == 5 || _global.sectionNumber == 6 || _global.sectionNumber == 7) {
				if (_global.playSwfFileName != _global.tempURL+"/RW/L10RW01.swf" && _global.playSwfFileName != _global.tempURL+"/VB/L10VB01.swf" && _global.playSwfFileName != _global.tempURL+"/IN/L10IN01.swf" && _global.playSwfFileName != _global.tempURL+"/GS/L10GS01.swf" && _global.playSwfFileName != _global.tempURL+"/TI/L10TI01.swf" && _global.playSwfFileName != _global.tempURL+"/TS/L10TS01.swf") {
