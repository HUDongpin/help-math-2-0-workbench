N17.swf~L1IN18.swf~L1IN19.swf~L1IN20.swf~L1IN21.swf~L1IN22.swf~L1IN23.swf~L1IN24.swf~L1IN25.swf~L1IN26.swf~L1IN27.swf~L1IN28.swf~L1IN29.swf~L1IN30.swf~L1IN31.swf~L1IN32.swf~L1IN33.swf~L1IN34.swf~L1IN35.swf~L1IN36.swf~L1IN37.swf~L1IN38.swf[Details_Split][Section5Details]~TI~L1TI01.swf~L1TI02.swf~L1TI03.swf~L1TI04.swf~L1TI05.swf~L1TI06.swf[Details_Split][Section6Details]~GS~L1GS01.swf~L1GS02.swf[Details_Split][Section7Details]~TS~L1TS01.swf~L1TS02.swf~L1TS03.swf~L1TS04.swf~L1TS05.swf~L1TS06.swf~L1TS07.swf~L1TS08.swf[Details_Split][Section8Details]~FQ~L1FQ01.swf~L1FQ02.swf~L1FQ03.swf";
SlideSpaceDetails = "[Section1Details]~IR[Details_Split][Section2Details]~RW[Details_Split][Section3Details]~VB~3~4~5~6~10~11~13~14~16~17[Details_Split][Section4Details]~IN~3~4~6~8~11~14~15~16~19~21~22~23~25~27~30~32~33~35~36~37~38[Details_Split][Section5Details]~TI[Details_Split][Section6Details]~GS[Details_Split][Section7Details]~TS[Details_Split][Section8Details]~FQ";
RandomAudioDetails = "[Section1Details]~IR~L1RW01.swf[Details_Split][Section2Details]~RW[Details_Split][Section3Details]~VB~L1VB01.swf[Details_Split][Section4Details]~IN~L1IN01.swf[Details_Split][Section5Details]~TI~L1TI01.swf[Details_Split][Section6Details]~GS~L1GS01.swf[Details_Split][Section7Details]~TS";
BGTextDetails = "[Section1Details]~IR~L1RW01.swf[Details_Split][Section2Details]~RW[Details_Split][Section3Details]~VB~L1VB01.swf[Details_Split][Section4Details]~IN~L1IN01.swf[Details_Split][Section5Details]~TI~L1TI01.swf[Details_Split][Section6Details]~GS~L1GS01.swf[Details_Split][Section7Details]~TS~L1TS01.swf";
//Vars End
...
function doCreateSlide() {
	...
	if (_global.sectionNumber == 3) {
		...
		slideName[1] = "Place-value chart, place value models";	
		slideName[2] = "Place-value chart, place value models";
		slideName[3] = "Place-value chart, place value models";
		slideName[4] = "Place-value chart, place value models";	
		slideName[5] = "Place-value chart, place value models";	
		
		slideName[6] = "Place value, place";
				
		slideName[7] = "Ones Group, Thousands Group";
		
		slideName[8] = "Word Form";
		slideName[9] = "Word Form";
		slideName[10] = "Word Form";	
		
		slideName[11] = "Standard Form and Expanded Form";
		slideName[12] = "Standard Form and Expanded Form";	
		slideName[13] = "Standard Form and Expanded Form";
		
		slideName[14] = "Rounding";
		//slideName[15] = "Rounding";
		//slideName[16] = "Rounding";
	...
	if (_global.sectionNumber == 4) {
		...
		slideName[1] = "Reading and Writing Whole Numbers in Word and Standard Forms";				
		slideName[2] = "Reading and Writing Whole Numbers in Word and Standard Forms";
		slideName[3] = "Reading and Writing Whole Numbers in Word and Standard Forms";

		slideName[4] = "Using Models to Represent Numbers";
		slideName[5] = "Using Models to Represent Numbers";		

		slideName[6] = "Identifying Place Value of Whole Numbers";
		slideName[7] = "Identifying Place Value of Whole Numbers";

		slideName[8] = "Reading Numbers Practice";				

		slideName[9] = "Write Numbers";
		slideName[10] = "Write Numbers";

		slideName[11] = "Write Numbers Practice";

		slideName[12] = "Reading and Writing Numbers in Expanded Form";
		slideName[13] = "Reading and Writing Numbers in Expanded Form";
		slideName[14] = "Reading and Writing Numbers in Expanded Form";
		slideName[15] = "Reading and Writing Numbers in Expanded Form";

		slideName[16] = "Word, Standard and Expanded Form Practice";

		slideName[17] = "Round Whole Numbers Using a Number Line";
		slideName[18] = "Round Whole Numbers Using a Number Line";

		slideName[19] = "Round Whole Numbers to the Nearest Tens Place Using Rules";
		slideName[20] = "Round Whole Numbers to the Nearest Tens Place Using Rules";
		slideName[21] = "Round Whole Numbers to the Nearest Tens Place Using Rules";
		slideName[22] = "Round Whole Numbers to the Nearest Tens Place Using Rules";

		slideName[23] = "Round Whole Numbers to the Nearest Hundreds Using Rules";
		slideName[24] = "Round Whole Numbers to the Nearest Hundreds Using Rules";				

		slideName[25] = "Round Whole Numbers to the Nearest Thousands Using Rules";
		slideName[26] = "Round Whole Numbers to the Nearest Thousands Using Rules";

		slideName[27] = "Rounding Whole Numbers Practice";

		slideName[28] = "Compare Whole Numbers";
		slideName[29] = "Compare Whole Numbers";

		slideName[30] = "Compare Whole Numbers Using Place Value";
		slideName[31] = "Compare Whole Numbers Using Place Value";
		slideName[32] = "Compare Whole Numbers Using Place Value";

		slideName[33] = "Order Whole Numbers Problem Solving";
		slideName[34] = "Order Whole Numbers Problem Solving";
		slideName[35] = "Order Whole Numbers Problem Solving";
		slideName[36] = "Order Whole Numbers Problem Solving";
		slideName[37] = "Order Whole Numbers Problem Solving";
	...
	if (_root.dtfSPANISH.text == "ON") {
		if (_global.spanSound != true) {
			if (_global.sectionNumber == 2 || _global.sectionNumber == 3 || _global.sectionNumber == 4 || _global.sectionNumber == 5 || _global.sectionNumber == 6 || _global.sectionNumber == 7) {
				if (_global.playSwfFileName != _global.tempURL+"/RW/L1RW01.swf" && _global.playSwfFileName != _global.tempURL+"/VB/L1VB01.swf" && _global.playSwfFileName != _global.tempURL+"/IN/L1IN01.swf" && _global.playSwfFileName != _global.tempURL+"/GS/L1GS01.swf" && _global.playSwfFileName != _global.tempURL+"/TI/L1TI01.swf" && _global.playSwfFileName != _global.tempURL+"/TS/L1TS01.swf") {
