...
//LMS END
	...
	/* Begin Show Title */
	varTempTitleName = "";
	varTempTitleName = LessonName + ": ";
	switch (_global.Section) {
		case "Introduction":
			varTempTitleName = varTempTitleName + "Introduction";
			break;
		case "Real World":
			varTempTitleName = varTempTitleName + "Your World";
			break;
		case "Vocabulary":
			varTempTitleName = varTempTitleName + "Important Words";
			break;
		case "Instruction":
			varTempTitleName = varTempTitleName + "Learn It";
			break;
		case "Try It":
			varTempTitleName = varTempTitleName + "Try It";
			break;
		case "Games":
			varTempTitleName = varTempTitleName + "Play It";
			break;
		case "Test and Skills":
			varTempTitleName = varTempTitleName + "Practice Test";
			break;
		case "Final Quiz":
			varTempTitleName = varTempTitleName + "Final Quiz";
			break;		
	}
	Mc_Page_Title.txtTitle.type = "dynamic";
	Mc_Page_Title.txtTitle.htmlText = "";
	if (_global.Section!="Introduction" && _global.playSwfFileName.indexOf("FQ01")<=0) {
	//	varTempTitleName = "Positive and Negative Numbers Positive and Negative Numbers: Real World Activity";
		varTempTitleName = varTempTitleName.split('amp;').join('');
		Mc_Page_Title.txtTitle.htmlText = varTempTitleName;
		Mc_Page_Title.txtTitle.type = "static";
		Mc_Page_Title.txtTitle.autoSize = true;
		if (Math.round(Mc_Page_Title.txtTitle._height)<=40) {
			Mc_Page_Title._y = 76;
		} else {
			Mc_Page_Title._y = 64;
		}
