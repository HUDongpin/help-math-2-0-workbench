...
SlideSpaceDetails = "[Section1Details]~IR[Details_Split][Section2Details]~RW[Details_Split][Section3Details]~VB~4~5~7~13~16~24[Details_Split][Section4Details]~IN~3~6~7~12~14~16~17~18~21~24~25~28~30~32~33~34~35[Details_Split][Section5Details]~TI[Details_Split][Section6Details]~GS[Details_Split][Section7Details]~TS[Details_Split][Section8Details]~FQ";
RandomAudioDetails = "[Section1Details]~IR~L1RW01.swf[Details_Split][Section2Details]~RW[Details_Split][Section3Details]~VB~L1VB01.swf[Details_Split][Section4Details]~IN~L1IN01.swf[Details_Split][Section5Details]~TI~L1TI01.swf[Details_Split][Section6Details]~GS[Details_Split][Section7Details]~TS";
BGTextDetails = "[Section1Details]~IR~L1RW01.swf[Details_Split][Section2Details]~RW~L1RW01.swf[Details_Split][Section3Details]~VB~L1VB01.swf[Details_Split][Section4Details]~IN~L1IN01.swf[Details_Split][Section5Details]~TI~L1TI01.swf[Details_Split][Section6Details]~GS~L1GS01.swf[Details_Split][Section7Details]~TS~L1TS01.swf";
//Vars End
...
function doCreateSlide() {
	...
	if (_global.sectionNumber == 3) {
		...
		slideName[2] = "Place Value";		
		slideName[3] = "Place Value";		
		slideName[4] = "Place Value";	
						
		slideName[5] = "Periods";			
		slideName[6] = "Periods";
				
		slideName[7] = "Base 10 Number System";
		
		slideName[8] = "Standard Form";
				
		slideName[9] = "Word Form";
		
		slideName[10] = "Expanded Form";	
		
		slideName[11] = "Which form?";	
		slideName[12] = "Which form?";	
		
		slideName[13] = "Decimal";
		
		slideName[14] = "Decimal Point";		
		slideName[15] = "Decimal Point";
		
		slideName[16] = "Tenth";
		
		slideName[17] = "Hundredth";		
		
		slideName[18] = "Tenth Practice";
		
		slideName[19] = "Hundredth Practice";
		
		slideName[20] = "Number Line";	
		
		slideName[21] = "Compare Numbers";	
		
		slideName[22] = "Order Numbers";		
		slideName[23] = "Order Numbers";	
	...
	if (_global.splitStart == 0 || _global.splitEnd == 0) {
		...
		if (_global.sectionNumber == 4) {
			...
			intSlideNum = 0;
					...
					slideName[1] = "Base 10 Blocks";//2				
					slideName[2] = "Base 10 Blocks";//3

					slideName[3] = "Read Numbers";//4

					slideName[4] = "Write Numbers";//5
					slideName[5] = "Write Numbers";//6	
					slideName[6] = "Write Numbers";//7

					slideName[7] = "Value of Digits";//8
					
					slideName[8] = "Value of Digits/Expanded Form";//9
					
					slideName[9] = "Value of Digits Practice";//10

					slideName[10] = "Compare Numbers";//11
					slideName[11] = "Compare Numbers";//12
					
					slideName[12] = "Order Numbers";//13
					slideName[13] = "Order Numbers";//14
					
					slideName[14] = "Round Numbers";//15
					slideName[15] = "Round Numbers";//16
					slideName[16] = "Round Numbers";//17
					slideName[17] = "Round Numbers";//18

					slideName[18] = "Solve Problems with Rounding";//19

					slideName[19] = "Base 10 Blocks/Decimals";//20
					slideName[20] = "Base 10 Blocks/Decimals";//21
					
									
					slideName[21] = "Read Decimals";//22
					
					slideName[22] = "Write Decimals";//23
					slideName[23] = "Write Decimals";//24
					slideName[24] = "Write Decimals";//25		
					
					slideName[25] = "Value of Digits/Decimals";//26
					
					slideName[26] = "Compare Decimals";//27
					slideName[27] = "Compare Decimals";//28
					
					slideName[28] = "Order Decimals";//29					
					slideName[29] = "Order Decimals";//30
					
					slideName[30] = "Round Decimals";//31
					slideName[31] = "Round Decimals";//32
					slideName[32] = "Round Decimals";//33
					slideName[33] = "Round Decimals";//34
					slideName[34] = "Round Decimals";//35
					
					slideName[35] = "Solve Problems with Rounding";//36
	...
	if (_root.dtfSPANISH.text == "ON") {
		if (_global.spanSound != true) {
			if (_global.sectionNumber == 2 || _global.sectionNumber == 3 || _global.sectionNumber == 4 || _global.sectionNumber == 5 || _global.sectionNumber == 6 || _global.sectionNumber == 7) {
				// _global.playSwfFileName != _global.tempURL+"/IN/L1IN21.swf" && _global.playSwfFileName != _global.tempURL+"/IN/L1IN22.swf" && _global.playSwfFileName != _global.tempURL+"/IN/L1IN23.swf" && _global.playSwfFileName != _global.tempURL+"/IN/L1IN24.swf" && _global.playSwfFileName != _global.tempURL+"/IN/L1IN25.swf" && _global.playSwfFileName != _global.tempURL+"/IN/L1IN26.swf" &&
