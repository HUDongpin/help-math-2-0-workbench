...
- Course Map: `false`
- Key Terms: `true`
- FQ full traversal/review/replay: `true`
- Persistence: `true`
- Per-page direct URL available: `false`
- Network boundary: `false`
