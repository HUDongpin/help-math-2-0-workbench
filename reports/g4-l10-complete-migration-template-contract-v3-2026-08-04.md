# Grade 4 Lesson 10 complete-migration template contract v3

Evidence date: **2026-08-04**  
Status: **fail-closed-template-not-stable**  
Template stable: **false**  
Fingerprint: `821786daeea59208f7ca696fc998e4c38afbca0f3f5a1f5cdd6edb2aacb4e210`
...
V3 now binds **269 member-level records** with closure SHA-256 `d47014d06d2e23f197c97ee8d8aae46c75106980645fad158066eb6fcc284319`: 47 migration manifests, 47 full-frame coverage files, 47 checklists, 47 audio inventories, 47 SWFs, and 34 FLAs. It also binds 24 module files, 24 timeline files, the candidate test, and four registries. Any later bound-file SHA drift makes `--check` fail.
...
- Current JavaScript: 24 source-static engineering candidates / 6,260 declared candidate frames; module closure `7489804dfaf22e7b582a4561820194cc5a525b245e88d1a9c981fdf6636ba199`; timeline closure `3fac5d4516ac664ad326fcc46282a234bd897ede10453ff5000e4feebe3a64ad`; registry references 0. The two separately bound browser diagnostics contain 210 captures and formal effect 0.
...
The attributed writer was task `019fc03e-a691-7553-98a6-195a74688d81` (继续完成 L10 正式迁移); task status was systemError, latest turn completed, then idle/quiescent. This metadata has acceptance effect none.

The `88704c7bd5979ae78e341eb6783d48a702713ae3830daaca1fdc4de35f42c07b` A/B digest is explicitly a historical pre-v2-write observation, not the current v3 tree digest. Currentness is enforced by the dynamic v3 input bindings. V1 and rejected v2 remain preserved byte-for-byte.
