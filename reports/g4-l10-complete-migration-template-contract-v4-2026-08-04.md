# Grade 4 Lesson 10 complete-migration template contract v4

Evidence date: **2026-08-04**  
Status: **fail-closed-template-not-stable**  
Template stable: **false**  
Fingerprint: `cd63a93da061a02b4bba0c8cde7db7d34c6524c2997ef9f0f983c74e7a740dcb`

## Outcome

V4 preserves v3 as a rejected attempt after independent review found one P1: v3's 24-module and 24-timeline direct closure omitted shared runtime and authority dependencies. V4 recursively resolves every local import from those 48 entry files and binds the resulting **53-file** code closure (SHA-256 `a5105dbfc86efd9111975395cfc2f7c3d6cbda7d2ae072e30dbafb23bbebf893`). It separately binds all **24** timeline-declared runtime assets and verifies every asset against its declared digest (closure SHA-256 `b736fa0a4434788032dc7fdea4251cd802560ec2c6b9aa29a75ff41f2ed825a8`; mismatches 0).
...
| Path | Bytes | SHA-256 |
|---|---:|---|
| `packages/demos/src/contract.ts` | 8064 | `6d76b0237a1ed7e7b003791fa3a63023b1b8bab79079125bf2b9e24418daf0c5` |
| `packages/demos/src/g4-l3-main-timeline-audio.generated.ts` | 33223 | `11be1bad01221721fec0342e6eae9d552b2c50ca62daeb466533ac0f7701f461` |
| `packages/demos/src/lesson-host-contract.ts` | 13881 | `ea99edb75eb61779c08c4928ef2296922eb94f5ed5da52dc2e0180b96f3bb4c9` |
| `packages/demos/src/source-static-candidate-authority.ts` | 817 | `8c8961ffc8e44e140be2c1871edb43bc7e34710872ae825c5e89ca7a3dada95d` |
| `packages/demos/src/source-static-canvas-candidate.tsx` | 37696 | `c2ef68a8fa7911099cd1d7dbeae30050cf43c2cbdb37f1a8f2c1aa5ea14ac2a0` |
...
- Member evidence/source closure: 269 files; SHA-256 `d47014d06d2e23f197c97ee8d8aae46c75106980645fad158066eb6fcc284319`.
- Recursive local candidate-code closure: 53 files / 180303 bytes; SHA-256 `a5105dbfc86efd9111975395cfc2f7c3d6cbda7d2ae072e30dbafb23bbebf893`.
- Digest-declared candidate runtime assets: 24 files / 45089726 bytes; SHA-256 `b736fa0a4434788032dc7fdea4251cd802560ec2c6b9aa29a75ff41f2ed825a8`; digest mismatches 0.
- Candidate set: 24 diagnostics / 6260 declared frames; registry references 0; formal effect none.
...
|---|---:|---:|---|
| source-custody | PASS-SOURCE-CUSTODY-ONLY | yes | No acceptance effect; custody is not runtime, renderer, audio, fidelity, review, or release proof. |
| audit | PARTIAL | no | Static/root planning exists, but 426 nested requirements and 34 FLA authoring audits remain unresolved. |
| original-runtime-baseline | BLOCKED | no | A named authorized operator and finalized pre-frame launch receipt are absent; unsigned kits and Ruffle are not original-runtime evidence. |
| specification | BLOCKED | no | Natural entry, schedule, entry-state identity, and bilingual/audio decisions remain unresolved for 426 nested requirements. |
| renderer | BLOCKED | no | Twenty-four source-static engineering candidates are unregistered, fixed-English/inert diagnostics and have zero formal renderer or acceptance effect. |
| behavior-tests | BLOCKED | no | There is no authoritative-baseline-bound formal renderer behavior acceptance. |
| visual-rmse | BLOCKED | no | There are no original-runtime-to-JavaScript RMSE results. |
| audio-listening | BLOCKED | no | Named listening/cue review is absent and the Grade 4 course closure still lacks 16 SHA-unresolved MP3s. |
| human-review | PENDING | no | No accepted human visual review records exist. |
| engineering-review | PENDING | no | No accepted engineering review records exist. |
| owner-review | PENDING | no | No owner acceptance records exist. |
| strict-completion | BLOCKED | no | The completion ledger has zero entries and zero strict-complete migrations. |
| atomic-lesson-release | BLOCKED | no | The 47-member all-or-none lesson gate is closed; no partial publication is allowed. |
...
| `catalog/completion-ledger.json` | 122550 | `62d5b5f71ed8ccbf94ba31132d3347f43ac4918585ece52ead8fbb36a4c0b92d` | `0644` |
...
| `catalog/lesson-release-ledger.json` | 102724 | `4ea4850993ffb50eb2ba484279457f7e98bbfa339a29a71f6092f23d4b7f4650` | `0644` |
