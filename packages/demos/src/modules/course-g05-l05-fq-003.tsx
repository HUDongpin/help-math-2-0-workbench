...
export const COURSE_G05_L05_FQ_003_RUNTIME = candidate.runtime;
export const COURSE_G05_L05_FQ_003_SOURCE_CONTRACT = candidate.sourceContract;
export const COURSE_G05_L05_FQ_003_SCENARIOS = candidate.scenarios;
export const COURSE_G05_L05_FQ_003_RENDERER = candidate.Renderer;
