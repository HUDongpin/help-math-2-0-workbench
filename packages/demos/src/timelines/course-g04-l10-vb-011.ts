...
export const COURSE_G04_L10_VB_011_CONFIG = Object.freeze({
  ...
  sourceControlBehaviorLabel:
    "The source-static core keeps ActionScript disabled; its private maintained wrapper binds the two exact glossary handlers plus source-exact engineering audio while Spanish visuals, natural runtime, terminal state, Replay parity, fidelity, and audio acceptance remain unresolved",
