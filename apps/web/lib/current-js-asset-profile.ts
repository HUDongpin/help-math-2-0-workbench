...
if (
  ...
  || productionProfileJson.counts.public !== 929
  || productionProfileJson.counts.serverAudio !== 185
  || productionProfileJson.counts.total !== 1114
  || productionProfileJson.entries.length !== 1114
...
if (
  ...
  || candidateProfileJson.counts.runtime !== 236
  || candidateProfileJson.counts.evidence !== 204
  || candidateProfileJson.entries.length !== 236
