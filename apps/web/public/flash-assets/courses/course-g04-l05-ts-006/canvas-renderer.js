...
function shape4(ctx,ctrans,frame,ratio,time){
	var pathData="M -3990 1033 L -3989 1042 -3990 1042 -3990 1033";
	ctx.fillStyle=tocolor(ctrans.apply([254,231,224,1]));
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 141 -1786 L 141 -491 137 -482 -3989 -481 -3990 -481 -3989 -482 -3990 -482 -3990 -1559 -3989 -1783 -3989 -1786 141 -1786 M 141 -261 L 141 1042 -3989 1042 -3990 1033 -3991 1033 -3990 -260 -1924 -261 77 -261 109 -261 141 -261 M 371 1042 L 371 1033 371 -221 372 -261 372 -260 2438 -261 4439 -261 4471 -261 4503 -261 4503 1042 1889 1042 1889 1038 1845 1033 1766 1033 1707 1042 371 1042 M 372 -482 L 372 -1484 373 -1484 372 -1511 372 -1559 373 -1783 4503 -1783 4503 -482 372 -481 379 -482 372 -482";
	ctx.fillStyle=tocolor(ctrans.apply([255,245,244,1]));
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 373 -1786 L 373 -1783 372 -1559 372 -1511 372 -1484 372 -482 372 -261 371 -221 371 1033 371 1042 371 1254 379 1262 141 1262 141 1042 141 -261 141 -262 141 -482 141 -491 141 -1786 141 -2006 373 -2006 373 -1786 M 279 -1689 L 279 -1691 279 -1689 M 277 936 L 278 938 278 936 277 936";
	var grd=ctx.createLinearGradient(134.5,-377.0,379.5,-377.0);
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 373 -1783 L 373 -1786 4503 -1786 4503 -1783 373 -1783";
	var grd=ctx.createLinearGradient(373.75,-1785.0,4504.25,-1785.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 373 -1786 L 373 -2006 4504 -2006 4504 -1786 4503 -1786 373 -1786";
	var grd=ctx.createLinearGradient(-497.0,-1785.5,-497.0,-2006.5);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 141 -2006 L 141 -1786 -3989 -1786 -3989 -2006 141 -2006";
	var grd=ctx.createLinearGradient(-4865.0,-1785.5,-4865.0,-2006.5);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 279 -1689 L 279 -1691 279 -1689";
	var grd=ctx.createLinearGradient(278.5,-1690.0,279.5,-1690.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 372 -1484 L 372 -1511 373 -1484 372 -1484";
	var grd=ctx.createLinearGradient(371.5,-1498.0,372.5,-1498.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 4471 -261 L 4439 -261 2438 -261 372 -260 372 -261 372 -481 4503 -482 4504 -482 4504 -262 4503 -262 4471 -261";
	var grd=ctx.createLinearGradient(-497.0,-261.5,-497.0,-482.5);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 372 -261 L 372 -482 379 -482 372 -481 372 -261";
	var grd=ctx.createLinearGradient(372.5,-371.0,379.5,-371.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 141 -491 L 141 -482 137 -482 141 -491";
	var grd=ctx.createLinearGradient(136.5,-487.0,141.5,-487.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 141 -482 L 141 -262 109 -261 77 -261 -1924 -261 -3990 -260 -3990 -261 -3989 -481 137 -482 141 -482";
	var grd=ctx.createLinearGradient(-4865.0,-261.5,-4865.0,-482.5);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 141 -262 L 141 -261 109 -261 141 -262";
	var grd=ctx.createLinearGradient(108.75,-262.0,141.25,-262.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 277 936 L 278 936 278 938 277 936";
	var grd=ctx.createLinearGradient(276.5,937.0,277.5,937.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 379 1262 L 371 1254 371 1042 1707 1042 1889 1042 4503 1042 4504 1042 4504 1262 379 1262";
	var grd=ctx.createLinearGradient(-497.0,1262.5,-497.0,1041.5);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 141 1042 L 141 1262 -3989 1262 -3989 1055 -3989 1042 141 1042";
	var grd=ctx.createLinearGradient(-4865.0,1262.5,-4865.0,1041.5);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 1889 1042 L 1707 1042 1766 1033 1845 1033 1889 1038 1889 1042";
	var grd=ctx.createLinearGradient(1707.5,1037.0,1888.5,1037.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 4503 -1783 L 4503 -1786 4504 -1786 4504 -2006 4608 -2006 4609 -1992 4610 -1986 4610 -1988 4609 -2006 4735 -2006 4735 -1783 4734 -1727 4734 1205 4733 1253 4733 1262 4504 1262 4504 1042 4503 1042 4503 -261 4503 -262 4504 -262 4504 -482 4503 -482 4503 -1783 M 4641 -1689 L 4641 -1691 4641 -1689 M 4640 936 L 4639 936 4640 938 4640 936 M 4607 1237 L 4606 1253 4608 1253 4609 1237 4608 1233 4607 1237";
	var grd=ctx.createLinearGradient(4496.5,-377.0,4741.5,-377.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 4609 -2006 L 4610 -1988 4610 -1986 4609 -1992 4608 -2006 4609 -2006";
	var grd=ctx.createLinearGradient(4607.75,-1997.0,4610.25,-1997.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 4641 -1689 L 4641 -1691 4641 -1689";
	var grd=ctx.createLinearGradient(4640.5,-1690.0,4641.5,-1690.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 4471 -261 L 4503 -262 4503 -261 4471 -261";
	var grd=ctx.createLinearGradient(4470.75,-262.0,4503.25,-262.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 4640 936 L 4640 938 4639 936 4640 936";
	var grd=ctx.createLinearGradient(4638.5,937.0,4639.5,937.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 4734 1205 L 4734 1253 4733 1253 4734 1205";
	var grd=ctx.createLinearGradient(4732.5,1220.0,4733.5,1220.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M -3990 -260 L -3991 1033 -3990 1033 -3990 1042 -3989 1055 -3989 1262 -4220 1262 -4220 1253 -4221 1253 -4221 -2006 -4111 -2006 -4115 -1992 -4114 -1986 -4110 -2006 -3989 -2006 -3989 -1786 -3989 -1783 -3990 -1559 -3990 -482 -3990 -261 -3990 -260 M -4083 -1689 L -4083 -1691 -4083 -1689 M -4085 936 L -4084 938 -4084 936 -4085 936 M -4117 1237 L -4113 1253 -4112 1253 -4116 1233 -4117 1237";
	var grd=ctx.createLinearGradient(-4227.5,-377.0,-3982.5,-377.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M -3990 -482 L -3989 -482 -3990 -481 -3989 -481 -3990 -261 -3990 -482";
	var grd=ctx.createLinearGradient(-3990.5,-371.0,-3989.5,-371.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M -3989 1055 L -3990 1042 -3989 1042 -3989 1055 M -3990 -261 L -3990 -260 -3990 -261";
	var grd=ctx.createLinearGradient(-3991.5,396.0,141.5,396.0);
	grd.addColorStop(0.01568627450980392,tocolor(ctrans.apply([249,159,106,1])));
	grd.addColorStop(0.12941176470588237,tocolor(ctrans.apply([251,183,142,1])));
	grd.addColorStop(0.37254901960784315,tocolor(ctrans.apply([255,255,255,1])));
	grd.addColorStop(0.7529411764705882,tocolor(ctrans.apply([252,206,173,1])));
...
function text6(ctx,ctrans,frame,ratio,time){
	...
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,120.0,460.0);
	font5(ctx," ",textColor);
	ctx.restore();
	ctx.save();
	...
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,382.0,460.0);
	font5(ctx," ",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,0,0,1]));
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,513.0,460.0);
	font5(ctx,"2",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,774.0,460.0);
	font5(ctx,".",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,153,0,1]));
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,905.0,460.0);
	font5(ctx," ",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,0,0,1]));
	ctx.save();
	...
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,1407.0,460.0);
	font5(ctx,"r",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,1563.0,460.0);
	font5(ctx,"g",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,1833.0,460.0);
	font5(ctx,"a",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,2103.0,460.0);
	font5(ctx,"n",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,2349.0,460.0);
	font5(ctx,"i",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,2447.0,460.0);
	font5(ctx,"z",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,2647.0,460.0);
	font5(ctx,"e",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,153,0,1]));
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,2907.0,460.0);
	font5(ctx," ",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,0,0,1]));
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,3038.0,460.0);
	font5(ctx,"t",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,3189.0,460.0);
	font5(ctx,"h",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,3438.0,460.0);
	font5(ctx,"e",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,0,0,1]));
	ctx.save();
...
function text7(ctx,ctrans,frame,ratio,time){
	var textColor = tocolor(ctrans.apply([0,0,0,1]));
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,260.0,460.0);
	font5(ctx," ",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,391.0,460.0);
	font5(ctx,"3",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,652.0,460.0);
	font5(ctx,".",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,153,0,1]));
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,783.0,460.0);
	font5(ctx," ",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,0,0,1]));
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,914.0,460.0);
	font5(ctx,"S",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,1166.0,460.0);
	font5(ctx,"o",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,1427.0,460.0);
	font5(ctx,"l",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,1525.0,460.0);
	...
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,2001.0,460.0);
	font5(ctx," ",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,2132.0,460.0);
	font5(ctx,"t",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,2283.0,460.0);
	font5(ctx,"h",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,2532.0,460.0);
	font5(ctx,"e",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,153,0,1]));
	ctx.save();
...
function text8(ctx,ctrans,frame,ratio,time){
	var textColor = tocolor(ctrans.apply([0,0,0,1]));
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,-1215.0,460.0);
	font5(ctx," ",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,-1084.0,460.0);
	font5(ctx,"4",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,-823.0,460.0);
	font5(ctx,".",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,153,0,1]));
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,-692.0,460.0);
	font5(ctx," ",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,0,0,1]));
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,-561.0,460.0);
	font5(ctx,"C",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,-322.0,460.0);
	font5(ctx,"h",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,-73.0,460.0);
	font5(ctx,"e",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,187.0,460.0);
	font5(ctx,"c",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,371.0,460.0);
	font5(ctx,"k",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,598.0,460.0);
	font5(ctx," ",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,729.0,460.0);
	font5(ctx,"y",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,975.0,460.0);
	font5(ctx,"o",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,1236.0,460.0);
	font5(ctx,"u",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,1482.0,460.0);
	font5(ctx,"r",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,0,0,1]));
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,-355.0,1080.0);
	font5(ctx,"w",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,18.0,1080.0);
	font5(ctx,"o",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,279.0,1080.0);
	font5(ctx,"r",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,435.0,1080.0);
	font5(ctx,"k",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,662.0,1080.0);
	font5(ctx,".",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,153,0,1]));
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,793.0,1080.0);
	font5(ctx," ",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,924.0,1080.0);
	font5(ctx," ",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.46875,0.0,0.0,0.46875,1055.0,1080.0);
	font5(ctx," ",textColor);
	ctx.restore();
	ctx.save();
...
function sprite13(ctx,ctrans,frame,ratio,time){
	ctx.save();
	ctx.transform(1,0,0,1,211.05,100.3);
	var clips = [];
	var frame_cnt = 245;
	...
	switch(frame){
		case 0:
			...
			place("text6",canvas,ctx,[0.05,0.0,0.0,0.05,-222.45,-16.2],ctrans,1,0,0,time);
			place("text7",canvas,ctx,[0.05,0.0,0.0,0.05,3.15,-91.65],ctrans,1,0,0,time);
			place("text8",canvas,ctx,[0.05,0.0,0.0,0.05,77.35,-16.85],ctrans,1,0,0,time);
			place("text9",canvas,ctx,[0.05,0.0,0.0,0.05,-184.1,-92.0],ctrans,1,0,0,time);
			place("text10",canvas,ctx,[0.05,0.0,0.0,0.05,-194.15,-92.0],ctrans,1,0,0,time);
			place("text11",canvas,ctx,[0.05,0.0,0.0,0.05,-112.95,-85.75],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-252.4,-92.25],ctrans,1,0,0,time);
			break;
		case 1:
			place("shape4",canvas,ctx,[0.05,0.0,0.0,0.05,0.0,0.0],ctrans,1,0,0,time);
			place("text6",canvas,ctx,[0.05,0.0,0.0,0.05,-222.45,-16.2],ctrans,1,0,0,time);
...
var METADATA = deepFreeze({
  ...
  "sourceSwfSha256": "202679b02b13aac87adcfcef2a5849856c2f475e250f32bdc07bcef32364f9f2",
  "generatorInput": {
    ...
    "framesHtmlSha256": "36ea6e7965dde41b709739cfbd94c299eb3fd5e37c73e1bd768743ce938f07af",
    "targetSpriteObjectId": 13
  },
  "stage": {
    "width": 800,
    "height": 600,
...
function render(targetCanvas, request) {
    ...
    if (ctx[marker] === undefined) {
        enhanceContext(ctx);
        Object.defineProperty(ctx, marker, {value: "course-g04-l05-ts-006", configurable: false, enumerable: false});
    } else if (ctx[marker] !== "course-g04-l05-ts-006") {
    ...
    ctx.save();
    try {
        ctx.transform(1.000045776367188, 0, 0, 1, 200.990338897705, 183.09999999999997);
        sprite13(ctx, new cxform(0,0,0,0,255,255,255,255), state.exportFrame, 0, 0);
    } finally {
        ctx.restore();
...
if (Object.prototype.hasOwnProperty.call(registry, "course-g04-l05-ts-006")) {
    throw new Error("canvas asset is already registered: " + "course-g04-l05-ts-006");
}
registry["course-g04-l05-ts-006"] = Object.freeze({metadata: METADATA, ready: ready, resolveFrameState: resolveFrameState, render: render});
})(globalThis);
