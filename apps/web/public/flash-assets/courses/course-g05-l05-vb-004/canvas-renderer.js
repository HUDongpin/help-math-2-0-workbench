...
function morphshape4(ctx,ctrans,frame,ratio,time){
	var pathData="M -4752 -4752 285 285 L -4752 -4752 825 825 -4692 4647 825 825 -4692 4647 285 285 -4752 -4752 285 285";
	...
	ctx.fill("evenodd");
	var pathData="M -4752 -4752 285 285 L -4692 4647 285 285 -4692 4647 825 825 -4752 -4752 825 825 -4752 -4752 285 285 Z";
...
function shape5(ctx,ctrans,frame,ratio,time){
	var pathData="M 787 715 L 2587 715 M -1332 715 L -133 715 M -4232 715 L -3572 715";
	var scaleMode = "NORMAL";
...
function text6(ctx,ctrans,frame,ratio,time){
	...
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,522.0,380.0);
	...
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,829.0,380.0);
	...
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,1225.0,380.0);
	font1(ctx,"s",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,1398.0,380.0);
	font1(ctx," ",textColor);
	ctx.restore();
	ctx.save();
	...
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,2696.0,380.0);
	font1(ctx," ",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,2805.0,380.0);
	font1(ctx,"o",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,3023.0,380.0);
	font1(ctx,"r",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,3153.0,380.0);
	font1(ctx," ",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,0,204,1]));
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,3262.0,380.0);
	font1(ctx,"s",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,3435.0,380.0);
	font1(ctx,"y",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,3640.0,380.0);
	font1(ctx,"m",textColor);
	ctx.restore();
	ctx.save();
	...
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,4394.0,380.0);
	font1(ctx,"l",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,0,0,1]));
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,4476.0,380.0);
	font1(ctx," ",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,4585.0,380.0);
	font1(ctx,"t",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,4711.0,380.0);
	...
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,5270.0,380.0);
	font1(ctx," ",textColor);
	ctx.restore();
	var textColor = tocolor(ctrans.apply([0,0,204,1]));
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,5379.0,380.0);
	font1(ctx,"r",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,5509.0,380.0);
	font1(ctx,"e",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,5726.0,380.0);
	font1(ctx,"p",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,5951.0,380.0);
	font1(ctx,"r",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,6081.0,380.0);
	font1(ctx,"e",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,6298.0,380.0);
	font1(ctx,"s",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,6471.0,380.0);
	font1(ctx,"e",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,6688.0,380.0);
	font1(ctx,"n",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,6893.0,380.0);
	font1(ctx,"t",textColor);
	ctx.restore();
	ctx.save();
	...
	var textColor = tocolor(ctrans.apply([0,0,0,1]));
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,7192.0,380.0);
	font1(ctx," ",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,7301.0,380.0);
	font1(ctx,"s",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,7474.0,380.0);
	font1(ctx,"o",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,7692.0,380.0);
	font1(ctx,"m",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,8003.0,380.0);
	font1(ctx,"e",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,8220.0,380.0);
	font1(ctx,"t",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,8346.0,380.0);
	font1(ctx,"h",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,8554.0,380.0);
	font1(ctx,"i",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,8636.0,380.0);
	font1(ctx,"n",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,8841.0,380.0);
	font1(ctx,"g",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.390625,0.0,0.0,0.390625,9066.0,380.0);
	font1(ctx,".",textColor);
	ctx.restore();
}
...
function shape11(ctx,ctrans,frame,ratio,time){
	var pathData="M 4647 825 L -4752 825 -4752 285 4647 285 4647 825";
...
function sprite16(ctx,ctrans,frame,ratio,time){
	ctx.save();
	ctx.transform(1,0,0,1,266.3,116.5);
	var clips = [];
	var frame_cnt = 205;
	frame = frame % frame_cnt;
	switch(frame){
		...
		case 1:
			...
			place("text6",canvas,ctx,[0.05,0.0,0.0,0.05,-258.15,-103.0],ctrans,1,0,0,time);
			place("button8",canvas,ctx,[0.016728973388671874,0.0,0.0,0.029974365234375,-224.15,-87.6],ctrans,1,0,1,time);
			place("button9",canvas,ctx,[0.027986907958984376,0.0,0.0,0.029965972900390624,-65.65,-88.15],ctrans,1,0,1,time);
			place("button10",canvas,ctx,[0.0414581298828125,0.0,0.0,0.028261566162109376,56.35,-88.05],ctrans,1,0,1,time);
			var o = clips.pop();
		...
		case 2:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,1725,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 3:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,3449,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 4:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,5174,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 5:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,6899,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 6:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,8623,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 15:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,10348,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 16:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,12072,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 17:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,13797,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 18:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,15522,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 19:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,17246,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 20:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,18971,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 21:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,20696,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 22:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,22420,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 23:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,24145,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 24:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,25869,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 25:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,27594,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 26:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,29319,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 27:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,31043,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 28:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,32768,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 35:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,34493,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 36:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,36217,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 37:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,37942,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 38:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,39667,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 39:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,41391,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 40:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,43116,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 41:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,44840,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 42:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,46565,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 43:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,48290,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 44:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,50014,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 45:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,51739,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 46:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,53464,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 47:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,55188,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 48:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,56913,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 49:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,58637,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 50:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,60362,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 51:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,62087,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 52:
			...
			canvas = ccanvas;
			ctx = cctx;
			place("morphshape4",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,63811,time);
			clips[clips.length-1].clipCanvas = canvas;
			canvas = createCanvas(canvas.width,canvas.height);
			var nctx = canvas.getContext("2d");
			enhanceContext(nctx);
		...
		case 53:
			...
			place("shape5",canvas,ctx,[0.05,0.0,0.0,0.05,-28.7,-116.5],ctrans,1,0,0,time);
			place("text6",canvas,ctx,[0.05,0.0,0.0,0.05,-258.15,-103.0],ctrans,1,0,0,time);
			place("button8",canvas,ctx,[0.016728973388671874,0.0,0.0,0.029974365234375,-224.15,-87.6],ctrans,1,0,53,time);
			place("button9",canvas,ctx,[0.027986907958984376,0.0,0.0,0.029965972900390624,-65.65,-88.15],ctrans,1,0,53,time);
			place("button10",canvas,ctx,[0.0414581298828125,0.0,0.0,0.028261566162109376,56.35,-88.05],ctrans,1,0,53,time);
			var o = clips.pop();
			ctx.globalCompositeOperation = "destination-in";
			ctx.setTransform(1,0,0,1,0,0);
			ctx.drawImage(o.clipCanvas,0,0);
		...
		case 54:
			...
			ctx = o.ctx;
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,0)),1,0,0,time);
			break;
		case 55:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
		...
		case 62:
			...
			ctx = o.ctx;
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.0875,0.0,0.0,0.0875,-194.45,-55.4],ctrans.merge(new cxform(0,0,0,0,256,256,256,64)),1,0,0,time);
			break;
		case 63:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			ctx = o.ctx;
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.125,0.0,0.0,0.125,-205.55,-71.05],ctrans.merge(new cxform(0,0,0,0,256,256,256,128)),1,0,0,time);
			break;
		case 64:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			ctx = o.ctx;
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.1625,0.0,0.0,0.1625,-216.5,-86.85],ctrans.merge(new cxform(0,0,0,0,256,256,256,192)),1,0,0,time);
			break;
		case 65:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			ctx = o.ctx;
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.2,0.0,0.0,0.2,-227.6,-102.55],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 66:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			ctx = o.ctx;
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.175,0.0,0.0,0.175,-220.35,-92.05],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 67:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			ctx = o.ctx;
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.15,0.0,0.0,0.15,-212.95,-81.65],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 68:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			ctx = o.ctx;
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.125,0.0,0.0,0.125,-205.6,-71.1],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 69:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			ctx = o.ctx;
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.1,0.0,0.0,0.1,-198.25,-60.65],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 70:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			ctx = o.ctx;
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.075,0.0,0.0,0.075,-190.9,-50.2],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 71:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			ctx = o.ctx;
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 72:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
		...
		case 115:
			...
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.25,0.0,0.0,0.25,-190.45,-120.2],ctrans.merge(new cxform(0,0,0,0,256,256,256,0)),1,0,0,time);
			break;
		case 116:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.21666336059570312,0.0,0.0,0.21666336059570312,-184.0,-106.75],ctrans.merge(new cxform(0,0,0,0,256,256,256,43)),1,0,0,time);
			break;
		case 117:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.18333053588867188,0.0,0.0,0.18333053588867188,-177.6,-93.25],ctrans.merge(new cxform(0,0,0,0,256,256,256,85)),1,0,0,time);
			break;
		case 118:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.14999771118164062,0.0,0.0,0.14999771118164062,-171.15,-79.85],ctrans.merge(new cxform(0,0,0,0,256,256,256,128)),1,0,0,time);
			break;
		case 119:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.11666488647460938,0.0,0.0,0.11666488647460938,-164.7,-66.5],ctrans.merge(new cxform(0,0,0,0,256,256,256,171)),1,0,0,time);
			break;
		case 120:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.08333206176757812,0.0,0.0,0.08333206176757812,-158.3,-52.95],ctrans.merge(new cxform(0,0,0,0,256,256,256,213)),1,0,0,time);
			break;
		case 121:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			canvas = o.canvas;
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,-39.6],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 122:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
		...
		case 125:
			...
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,-39.6],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,-39.6],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans,1,0,0,time);
			break;
		case 126:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,-39.6],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,-22.95],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-23.05],ctrans,1,0,0,time);
			break;
		case 127:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,-39.6],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,-6.25],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-6.35],ctrans,1,0,0,time);
			break;
		case 128:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,-39.6],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,10.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,10.3],ctrans,1,0,0,time);
			break;
		case 129:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,-39.6],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,27.05],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,26.95],ctrans,1,0,0,time);
			break;
		case 130:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,-39.6],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,43.75],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,43.65],ctrans,1,0,0,time);
			break;
		case 131:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,-39.6],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,60.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			break;
		case 132:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
		...
		case 133:
			...
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,60.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,0)),1,0,0,time);
			break;
		case 134:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,60.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.07999954223632813,0.0,0.0,0.07999954223632813,38.15,-54.65],ctrans.merge(new cxform(0,0,0,0,256,256,256,51)),1,0,0,time);
			break;
		case 135:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,60.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.10999908447265624,0.0,0.0,0.10999908447265624,32.85,-69.65],ctrans.merge(new cxform(0,0,0,0,256,256,256,102)),1,0,0,time);
			break;
		case 136:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,60.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.14000091552734376,0.0,0.0,0.14000091552734376,27.5,-84.6],ctrans.merge(new cxform(0,0,0,0,256,256,256,154)),1,0,0,time);
			break;
		case 137:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,60.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.17000045776367187,0.0,0.0,0.17000045776367187,22.2,-99.6],ctrans.merge(new cxform(0,0,0,0,256,256,256,205)),1,0,0,time);
			break;
		case 138:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,60.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.2,0.0,0.0,0.2,16.9,-114.55],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 139:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,60.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.175,0.0,0.0,0.175,21.4,-102.05],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 140:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,60.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.15,0.0,0.0,0.15,25.75,-89.65],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 141:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,60.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.125,0.0,0.0,0.125,30.25,-77.1],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 142:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,60.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.1,0.0,0.0,0.1,34.6,-64.65],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 143:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,60.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.075,0.0,0.0,0.075,39.05,-52.2],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 144:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text13",canvas,ctx,[0.05,0.0,0.0,0.05,-151.85,60.4],ctrans,1,0,0,time);
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 145:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
		...
		case 146:
			...
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,0)),1,0,0,time);
			break;
		case 147:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
		...
		case 184:
			...
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,51)),1,0,0,time);
			break;
		case 185:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,102)),1,0,0,time);
			break;
		case 186:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,154)),1,0,0,time);
			break;
		case 187:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,205)),1,0,0,time);
			break;
		case 188:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text12",canvas,ctx,[0.05,0.0,0.0,0.05,-183.5,60.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			break;
		case 189:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
		...
		case 190:
			...
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans,1,0,0,time);
			break;
		case 191:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
		...
		case 194:
			...
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-22.85],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-22.85],ctrans,1,0,0,time);
			break;
		case 195:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-6.05],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-6.05],ctrans,1,0,0,time);
			break;
		case 196:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,10.8],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,10.8],ctrans,1,0,0,time);
			break;
		case 197:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,27.65],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,27.65],ctrans,1,0,0,time);
			break;
		case 198:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,44.45],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,44.45],ctrans,1,0,0,time);
			break;
		case 199:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
			...
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,-39.7],ctrans.merge(new cxform(0,0,0,0,256,256,256,256)),1,0,0,time);
			place("text15",canvas,ctx,[0.05,0.0,0.0,0.05,66.3,61.3],ctrans,1,0,0,time);
			place("text14",canvas,ctx,[0.05,0.0,0.0,0.05,43.45,61.3],ctrans,1,0,0,time);
			break;
		case 200:
			clips.push({ctx:ctx,canvas:canvas});
			var ccanvas = createCanvas(canvas.width,canvas.height);
...
var METADATA = deepFreeze({
  ...
  "sourceSwfSha256": "b0e87cff11a7d866591194914f687e023a443d73e716fa21d6fbf02d3830539e",
  "generatorInput": {
    ...
    "framesHtmlSha256": "e8803474906c7e563fdbe563566ec70ea117d693ed594178d3c43f4f098b524b",
  ...
  "deterministicContentTimeline": {
    ...
    "frameCount": 205,
    "livePlaybackEndFrame": 205,
    "trailingEmptyFrameCount": 0,
    "durationMs": 17083.333333333332,
    "playbackMode": "once",
...
function resolveFrameState(request) {
    ...
    if (!Number.isSafeInteger(frame) || frame < 1 || frame > 205) {
        throw new Error("frame must be a safe integer within 1..205");
    }
...
function renderInternal(targetCanvas, request, requireBehaviorComposite) {
    ...
    if (ctx[marker] === undefined) {
        enhanceContext(ctx);
        Object.defineProperty(ctx, marker, {value: "course-g05-l05-vb-004", configurable: false, enumerable: false});
    } else if (ctx[marker] !== "course-g05-l05-vb-004") {
    ...
    ctx.save();
    try {
        ctx.transform(1, 0, 0, 1, 135, 127.75);
...
if (Object.prototype.hasOwnProperty.call(registry, "course-g05-l05-vb-004")) {
    throw new Error("canvas asset is already registered: " + "course-g05-l05-vb-004");
}
registry["course-g05-l05-vb-004"] = Object.freeze({metadata: METADATA, ready: ready, resolveFrameState: resolveFrameState, render: render});
})(globalThis);
