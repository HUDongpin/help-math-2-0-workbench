...
function shape2(ctx,ctrans,frame,ratio,time){
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 279 -1689 L 279 -1691 279 -1689 M 373 -2006 L 373 -1786 373 -1783 372 -1559 372 -1511 372 -1484 372 -482 372 -261 371 -221 371 1033 371 1042 371 1254 379 1262 141 1262 141 1042 141 -261 141 -262 141 -482 141 -491 141 -1786 141 -2006 373 -2006 M 277 936 L 278 938 278 936 277 936";
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 372 -261 L 372 -481 4503 -482 4504 -482 4504 -262 4503 -262 4471 -261 4439 -261 2438 -261 372 -260 372 -261";
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 1707 1042 L 1766 1033 1845 1033 1889 1038 1889 1042 1707 1042";
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 4503 -1786 L 4504 -1786 4504 -2006 4608 -2006 4609 -1992 4610 -1986 4610 -1988 4609 -2006 4735 -2006 4735 -1783 4734 -1727 4734 1205 4733 1253 4733 1262 4504 1262 4504 1042 4503 1042 4503 -261 4503 -262 4504 -262 4504 -482 4503 -482 4503 -1783 4503 -1786 M 4641 -1689 L 4641 -1691 4641 -1689 M 4640 936 L 4639 936 4640 938 4640 936 M 4607 1237 L 4606 1253 4608 1253 4609 1237 4608 1233 4607 1237";
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M -3989 1055 L -3990 1042 -3989 1042 -3989 1055 M -3990 -260 L -3990 -261 -3990 -260";
...
function sprite12(ctx,ctrans,frame,ratio,time){
	...
	switch(frame){
		case 0:
			...
			place("text4",canvas,ctx,[0.05,0.0,0.0,0.05,-222.45,-16.2],ctrans,1,0,0,time);
			place("text5",canvas,ctx,[0.05,0.0,0.0,0.05,3.15,-91.65],ctrans,1,0,0,time);
			place("text6",canvas,ctx,[0.05,0.0,0.0,0.05,77.35,-16.85],ctrans,1,0,0,time);
			place("text7",canvas,ctx,[0.05,0.0,0.0,0.05,-184.1,-92.0],ctrans,1,0,0,time);
			place("text8",canvas,ctx,[0.05,0.0,0.0,0.05,-194.15,-92.0],ctrans,1,0,0,time);
			place("text10",canvas,ctx,[0.05,0.0,0.0,0.05,-112.95,-85.75],ctrans,1,0,0,time);
			place("text11",canvas,ctx,[0.05,0.0,0.0,0.05,-252.4,-92.25],ctrans,1,0,0,time);
			break;
		case 1:
			place("shape2",canvas,ctx,[0.05,0.0,0.0,0.05,0.0,0.0],ctrans,1,0,0,time);
			place("text4",canvas,ctx,[0.05,0.0,0.0,0.05,-222.45,-16.2],ctrans,1,0,0,time);
...
var METADATA = deepFreeze({
  ...
  "sourceSwfSha256": "70eb103755346b9502b658d67a3abd1c90c994ed8799d64064a65b8468e3f59f",
  "generatorInput": {
    "ffdec": "JPEXS Free Flash Decompiler v.26.2.1",
    "helperSha256": "78256220d01fba044341283703c3923a1ff8ff29499c51f65ab4e6ac825ccb93",
    "framesHtmlSha256": "1d7d065f1f0556787980582fd116c615132969268343c4c2c2c51a58b10aefd6",
    "targetSpriteObjectId": 12
  },
  "stage": {
    "width": 800,
    "height": 600,
...
function render(targetCanvas, request) {
    ...
    if (ctx[marker] === undefined) {
        enhanceContext(ctx);
        Object.defineProperty(ctx, marker, {value: "course-g05-l03-ts-006", configurable: false, enumerable: false});
    } else if (ctx[marker] !== "course-g05-l03-ts-006") {
    ...
    try {
        ...
        sprite12(ctx, new cxform(0,0,0,0,255,255,255,255), state.exportFrame, 0, 0);
    } finally {
        ctx.restore();
...
if (Object.prototype.hasOwnProperty.call(registry, "course-g05-l03-ts-006")) {
    throw new Error("canvas asset is already registered: " + "course-g05-l03-ts-006");
}
registry["course-g05-l03-ts-006"] = Object.freeze({metadata: METADATA, ready: ready, resolveFrameState: resolveFrameState, render: render});
})(globalThis);
