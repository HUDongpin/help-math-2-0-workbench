...
function shape4(ctx,ctrans,frame,ratio,time){
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 141 -2006 L 373 -2006 373 -1786 373 -1783 372 -1559 372 -1511 372 -1484 372 -482 372 -261 371 -221 371 1033 371 1042 371 1254 379 1262 141 1262 141 1042 141 -261 141 -262 141 -482 141 -491 141 -1786 141 -2006 M 279 -1689 L 279 -1691 279 -1689 M 277 936 L 278 938 278 936 277 936";
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 4504 -2006 L 4608 -2006 4609 -1992 4610 -1986 4610 -1988 4609 -2006 4735 -2006 4735 -1783 4734 -1727 4734 1205 4733 1253 4733 1262 4504 1262 4504 1042 4503 1042 4503 -261 4503 -262 4504 -262 4504 -482 4503 -482 4503 -1783 4503 -1786 4504 -1786 4504 -2006 M 4641 -1689 L 4641 -1691 4641 -1689 M 4640 936 L 4639 936 4640 938 4640 936 M 4607 1237 L 4606 1253 4608 1253 4609 1237 4608 1233 4607 1237";
	...
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 4608 -2006 L 4609 -2006 4610 -1988 4610 -1986 4609 -1992 4608 -2006";
...
var METADATA = deepFreeze({
  ...
  "sourceSwfSha256": "2604222b1666480568fc50929f68df43f6a1d8e4cc33fcd4d9d8f973c5187bdb",
  "generatorInput": {
    "ffdec": "JPEXS Free Flash Decompiler 26.2.1",
    "helperSha256": "78256220d01fba044341283703c3923a1ff8ff29499c51f65ab4e6ac825ccb93",
    "framesHtmlSha256": "8b9bde0dd325842ebb6232010d3140260eff56f8e9ede70babf137b17de3d8cc",
...
function resolveFrameState(request) {
    ...
    if (!Number.isSafeInteger(frame) || frame < 1 || frame > 246) {
        throw new Error("frame must be a safe integer within 1..246");
    }
...
function render(targetCanvas, request) {
    ...
    if (ctx[marker] === undefined) {
        enhanceContext(ctx);
        Object.defineProperty(ctx, marker, {value: "course-g03-l02-ts-006", configurable: false, enumerable: false});
    } else if (ctx[marker] !== "course-g03-l02-ts-006") {
    ...
    ctx.save();
    try {
        ctx.transform(1, 0, 0, 1, 201, 183.09999999999997);
...
if (Object.prototype.hasOwnProperty.call(registry, "course-g03-l02-ts-006")) {
    throw new Error("canvas asset is already registered: " + "course-g03-l02-ts-006");
}
registry["course-g03-l02-ts-006"] = Object.freeze({metadata: METADATA, ready: ready, resolveFrameState: resolveFrameState, render: render});
})(globalThis);
