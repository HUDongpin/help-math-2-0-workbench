...
function text24(ctx,ctrans,frame,ratio,time){
	...
	ctx.restore();
	ctx.save();
	ctx.transform(1.875,0.0,0.0,1.875,961.0,1840.0);
	font23(ctx," ",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(1.875,0.0,0.0,1.875,1484.0,1840.0);
...
function text28(ctx,ctrans,frame,ratio,time){
	...
	ctx.restore();
	ctx.save();
	ctx.transform(0.78125,0.0,0.0,0.78125,401.0,780.0);
	font23(ctx," ",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.78125,0.0,0.0,0.78125,620.0,780.0);
	font23(ctx,"4",textColor);
	ctx.restore();
	ctx.save();
	ctx.transform(0.78125,0.0,0.0,0.78125,1056.0,780.0);
	font23(ctx,"0",textColor);
	ctx.restore();
}

function shape29(ctx,ctrans,frame,ratio,time){
	var pathData="M 7824 -4118 L 99 -4118 99 -4617 99 -5163 99 -5681 99 -6227 99 -6759 99 -7291 99 -7851 7824 -7851 7824 -7291 7824 -6759 7824 -6227 7824 -5681 7824 -5163 7824 -4617 7824 -4118 M 7824 -6759 L 99 -6759 7824 -6759 M 7824 -5681 L 99 -5681 7824 -5681 M 7824 -4617 L 99 -4617 7824 -4617 M 7824 -6227 L 99 -6227 7824 -6227 M 7824 -7291 L 99 -7291 7824 -7291 M 7824 -5163 L 99 -5163 7824 -5163";
	ctx.fillStyle=tocolor(ctrans.apply([255,204,153,1]));
	drawPath(ctx,pathData,false);
	ctx.fill("evenodd");
	var pathData="M 99 -7851 L 7824 -7851 7824 -7291 7824 -6759 7824 -6227 7824 -5681 7824 -5163 7824 -4617 7824 -4118 M 99 -5163 L 7824 -5163 M 99 -7291 L 7824 -7291 M 99 -6227 L 7824 -6227 M 99 -4617 L 7824 -4617 M 99 -5681 L 7824 -5681 M 99 -6759 L 7824 -6759";
...
function sprite41(ctx,ctrans,frame,ratio,time){
	ctx.save();
	ctx.transform(1,0,0,1,308.45,184.8);
	var clips = [];
	var frame_cnt = 52;
	frame = frame % frame_cnt;
	switch(frame){
		case 0:
			place("text24",canvas,ctx,[0.026428985595703124,0.0,0.0,0.026427459716796876,194.95,90.0],ctrans.merge(new cxform(0,0,0,0,256,256,256,26)),1,0,0,time);
...
var METADATA = deepFreeze({
  ...
  "sourceSwfSha256": "a7efda88b3246f34b35df08ef6feb718d00cda4850f458bb777357caa994e832",
  "generatorInput": {
    "ffdec": "JPEXS Free Flash Decompiler v.26.2.1",
    "helperSha256": "78256220d01fba044341283703c3923a1ff8ff29499c51f65ab4e6ac825ccb93",
    "framesHtmlSha256": "3d98a5ce5fad521f7198d2b554e7c26365a1fe3ab331ee8baf9962a16eed8011",
...
function render(targetCanvas, request) {
    ...
    if (ctx[marker] === undefined) {
        enhanceContext(ctx);
        Object.defineProperty(ctx, marker, {value: "course-g04-l03-fq-001", configurable: false, enumerable: false});
    } else if (ctx[marker] !== "course-g04-l03-fq-001") {
    ...
    ctx.save();
    try {
        ctx.transform(1, 0, 0, 1, 103.95, 98.5);
...
if (Object.prototype.hasOwnProperty.call(registry, "course-g04-l03-fq-001")) {
    throw new Error("canvas asset is already registered: " + "course-g04-l03-fq-001");
}
registry["course-g04-l03-fq-001"] = Object.freeze({metadata: METADATA, ready: ready, resolveFrameState: resolveFrameState, render: render});
})(globalThis);
