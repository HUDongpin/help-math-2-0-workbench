...
export const esContent = {
  ...
  pages: {
    ...
    demos: {
      metadata: {
        title: "Demostración estudiantil apropiada para cada edad",
        description:
          "Prueba una lección de cuarto grado en experiencias de primaria, secundaria media y preparatoria, con apoyos bilingües y de accesibilidad siempre disponibles.",
      },
      hero: {
        eyebrow: "HELP Math 2.0 · Concepto interactivo de producto",
        title: "Una lección de matemáticas. Tres experiencias apropiadas para cada edad.",
        summary:
          "Descubre cómo la misma lección de números negativos de cuarto grado puede sentirse acogedora en primaria, enfocada en secundaria media y madura en preparatoria, sin quitar los apoyos lingüísticos y de aprendizaje.",
        primaryAction: { label: "Iniciar la demo de 3 minutos", href: "#experience" },
        secondaryAction: { label: "Ver los límites de evidencia", href: "#evidence" },
      },
      audienceLabel: "Diseñada para estudiantes que necesitan que las matemáticas se adapten a su punto de partida",
      audience: [
        "Estudiantes que aprenden inglés · English / Español / Bilingüe",
        "Estudiantes que reciben servicios de educación especial",
        "Estudiantes que necesitan más tiempo, lenguaje o apoyo visual",
      ],
      ageIndependenceNote:
        "La edad de presentación no es el nivel de instrucción. Un estudiante de preparatoria puede trabajar matemáticas de cuarto grado sin recibir una interfaz que parezca diseñada para niños pequeños.",
      experience: {
        eyebrow: "Interacción en vivo",
        title: "Prueba la misma lección en tres experiencias estudiantiles",
        intro:
          "Cambia la experiencia por edad. Después cambia el idioma o los apoyos. Las matemáticas siguen siendo de cuarto grado.",
        fixedLevelLabel: "Contenido de instrucción",
        fixedLevelValue: "Matemáticas de cuarto grado",
        ageSelectorLabel: "Experiencia estudiantil",
        ageSelectorHint:
          "Esto cambia la presentación, la densidad, la navegación y el tono del tutor, no las matemáticas.",
        modes: [
          {
            id: "elementary",
            label: "Primaria",
            grades: "Grados 3–5",
            badge: "Cálida y guiada",
          ...
          {
            id: "middle",
            label: "Secundaria media",
            grades: "Grados 6–8",
            badge: "Enfocada y flexible",
        ...
        supportTitle: "Los apoyos permanecen disponibles a cualquier edad",
        supportSummary:
          "Elige apoyo de forma privada. La interfaz no asigna un diagnóstico ni una etiqueta al estudiante.",
        languageLabel: "Idioma de la lección",
        languageOptions: [
          { id: "english", label: "English" },
          { id: "spanish", label: "Español" },
          { id: "dual", label: "Bilingüe" },
        ],
        toolsLabel: "Apoyos para aprender",
        readAloudLabel: "Leer en voz alta",
        stopReadAloudLabel: "Detener lectura",
        stepByStepLabel: "Paso a paso",
        visualModelLabel: "Modelo visual",
        reducedMotionLabel: "Reducir movimiento",
        activeSupportsLabel: "Apoyos activos",
        noActiveSupportsLabel: "Elige cualquier herramienta cuando te ayude.",
        speechUnavailable: "La lectura en voz alta no está disponible en este navegador.",
        ...
        stopsLabel: "Pasos de la lección",
        stops: [
          {
            emoji: "👋",
      ...
      principles: {
        ...
        title: "La dignidad por edad y el apoyo de aprendizaje son decisiones separadas",
        intro:
          "Una plataforma compartida de HELP Math puede adaptar su presentación sin esconder la ayuda ni hacer sentir más pequeños a los estudiantes mayores.",
        items: [
          {
            title: "Presentación apropiada para la edad",
            body:
              "El tono visual, las palabras, la densidad, el progreso y la autonomía maduran desde primaria hasta preparatoria.",
          },
          {
            title: "Acceso lingüístico desde el diseño",
            body:
              "Las vistas en inglés, español y bilingüe quedan a un toque y cada señal visual se acompaña con palabras.",
          },
          {
            title: "Apoyo sin estigma",
            body:
              "Lectura en voz alta, pasos pequeños, modelos visuales, teclado y movimiento reducido son herramientas normales para cualquier persona.",
          },
        ],
      },
      evidence: {
        id: "evidence",
        eyebrow: "Límite actual de evidencia",
        title: "Una demo creíble dice la verdad sobre su preparación",
        intro:
          "La lección 3 de cuarto grado es la candidata actual más sólida para la interfaz de una lección completa en el banco de trabajo. Esta página demuestra la dirección del producto sin presentarla como una lección publicada.",
        snapshotLabel: "Estado de evidencia · 14 de agosto de 2026",
        facts: [
          { value: "39", label: "páginas de lección registradas en JavaScript actual" },
          { value: "1", label: "shell funcional del curso en JavaScript actual" },
          { value: "0 / 40", label: "miembros atómicos estrictamente completos" },
          { value: "No publicada", label: "estado de publicación del curso" },
        ],
        demonstratesTitle: "Lo que demuestra esta página",
        demonstrates: [
          "Una experiencia adaptable y operable con teclado",
          "Controles independientes para edad de presentación, idioma y apoyos",
          "Una interacción funcional de números negativos inspirada en la candidata JavaScript actual",
          "Un concepto de interacción de Nova Tutor con guion y sin datos",
        ],
        remainsTitle: "Lo que sigue siendo independiente",
        remains: [
          "Aceptación del runtime Flash original y fidelidad del fotograma completo",
          "Fidelidad de audio, revisión visual humana y aceptación del propietario",
          "Servicios de IA en vivo, aprendizaje adaptativo, cuentas o datos estudiantiles",
          "Finalización estricta, revisión de derechos, lanzamiento y publicación",
        ],
        note:
          "G4 L3 es la candidata más madura para una lección completa y un producto de interfaz/JavaScript actual; no es un curso fiel a Flash, estrictamente completo, con audio u Owner aceptados ni publicado.",
      },
      accessibility: {
        title: "Ayúdanos a facilitar el uso de la experiencia",
        body:
          "Indica el navegador, dispositivo, idioma o interacción que presentó dificultades. No incluyas trabajo estudiantil, información de discapacidad ni datos personales.",
