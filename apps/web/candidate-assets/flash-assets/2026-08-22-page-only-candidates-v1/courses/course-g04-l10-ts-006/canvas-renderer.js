...
var METADATA = deepFreeze({
  ...
  "sourceSwfSha256": "b0ad832f7d755e2f94dddc53e3267414c5d8430ed0e8c28d498cc5ec3c05160e",
  "generatorInput": {
...
function render(targetCanvas, request) {
    ...
    if (ctx[marker] === undefined) {
        enhanceContext(ctx);
        Object.defineProperty(ctx, marker, {value: "course-g04-l10-ts-006", configurable: false, enumerable: false});
    } else if (ctx[marker] !== "course-g04-l10-ts-006") {
...
if (Object.prototype.hasOwnProperty.call(registry, "course-g04-l10-ts-006")) {
    throw new Error("canvas asset is already registered: " + "course-g04-l10-ts-006");
}
registry["course-g04-l10-ts-006"] = Object.freeze({metadata: METADATA, ready: ready, resolveFrameState: resolveFrameState, render: render});
})(globalThis);
