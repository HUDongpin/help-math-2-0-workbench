...
var METADATA = deepFreeze({
  ...
  "sourceSwfSha256": "efa39aa768ba3b5712286641153b80dc2210ee7bc6cad1fe3a16932434b581d1",
  "generatorInput": {
    "ffdec": "JPEXS Free Flash Decompiler v.26.2.1",
    "helperSha256": "78256220d01fba044341283703c3923a1ff8ff29499c51f65ab4e6ac825ccb93",
    "framesHtmlSha256": "6acabe5500f3f6f8217c26b4c38218a8d5b9abe6f945927f62888328c0c69784",
...
function render(targetCanvas, request) {
    ...
    if (ctx[marker] === undefined) {
        enhanceContext(ctx);
        Object.defineProperty(ctx, marker, {value: "course-g05-l04-ts-006", configurable: false, enumerable: false});
    } else if (ctx[marker] !== "course-g05-l04-ts-006") {
    ...
    ctx.save();
    try {
        ctx.transform(1, 0, 0, 1, 201, 183.1);
...
if (Object.prototype.hasOwnProperty.call(registry, "course-g05-l04-ts-006")) {
    throw new Error("canvas asset is already registered: " + "course-g05-l04-ts-006");
}
registry["course-g05-l04-ts-006"] = Object.freeze({metadata: METADATA, ready: ready, resolveFrameState: resolveFrameState, render: render});
})(globalThis);
