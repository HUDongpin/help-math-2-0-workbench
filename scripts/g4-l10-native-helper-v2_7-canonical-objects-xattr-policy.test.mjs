...
async function privateRoot(label) {
  const root = await mkdtemp(path.join(tmpdir(), `hmg4v27-xattr-${label}-`));
  ...
  const modules = [
    ...
    },
    {
      ...
      undefinedSymbols: [
        ...
        "_hmg4v27_successor_sha256", "_hmg4v27_tlv_cursor_init",
        "_hmg4v27_tlv_next_raw", "_hmg4v27_validate_authority_envelope",
        "_hmg4v27_validate_tlv_schema", "_memcmp",
      ],
    },
  ];
