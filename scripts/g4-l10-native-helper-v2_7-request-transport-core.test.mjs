...
async function privateRoot(label) {
  const root = await mkdtemp(path.join(tmpdir(), `hmg4v27-transport-${label}-`));
...
test("request transport object has exact symbols and reproducible bytes", {
  ...
  assert.deepEqual(definedSymbols, [
    "_hmg4v27_checked_add_u64",
    "_hmg4v27_deadline_from_start",
    "_hmg4v27_diagnostic_write_decide",
    "_hmg4v27_parse_request_header",
    "_hmg4v27_poll_timeout_ms",
    "_hmg4v27_request_read_decide",
    "_hmg4v27_response_write_decide",
    "_hmg4v27_timespec_parts_to_ns",
    "_hmg4v27_transport_result_name",
    "_hmg4v27_validate_buffered_request_frame",
  ].sort());
