...
async function privateRoot(label) {
  const root = await mkdtemp(path.join(tmpdir(), `hmg4v23-tlv-${label}-`));
...
test("canonical TLV object has exact symbols and reproducible bytes", {
  ...
  assert.deepEqual(undefinedResult.stdout.trim().split("\n").sort(), [
    ...
    "_hmg4v23_tlv_type_site_is_legal",
    "_memcmp",
  ]);
  ...
  assert.deepEqual(definedSymbols, [
    "_hmg4v23_approved_abs_root_is_lexically_safe",
    "_hmg4v23_build_rel_path_is_lexically_safe",
    "_hmg4v23_observed_custody_leaf_is_lexically_safe",
    "_hmg4v23_parse_custody_leaf",
    "_hmg4v23_parse_fixture_attempt",
    "_hmg4v23_parse_fixture_root",
    "_hmg4v23_policy_rel_path_is_lexically_safe",
    "_hmg4v23_tlv_cursor_init",
    "_hmg4v23_tlv_next_raw",
    "_hmg4v23_tlv_result_name",
    "_hmg4v23_validate_evidence_path",
    "_hmg4v23_validate_fixture_claim",
    "_hmg4v23_validate_fixture_root",
    "_hmg4v23_validate_tlv_schema",
  ].sort());
