...
int main(void) {
  uint8_t bytes[320]; size_t iteration, i; hmg4v27_authority_envelope envelope;
  hmg4v27_poll_symbols symbols={1,4,8,16,32,4}; hmg4v27_poll_decision decision;
  for (iteration=0; iteration<300000; ++iteration) {
    ...
    (void)hmg4v27_validate_authority_envelope((hmg4v27_span){bytes,length},&envelope);
    (void)hmg4v27_tlv_type_is_known((uint8_t)next_u32());
    (void)hmg4v27_poll_decide(&symbols,(next_u32()&1)?HMG4V27_POLL_ENDPOINT_REQUEST:HMG4V27_POLL_ENDPOINT_RESPONSE,
