#ifndef HMG4V27_CANONICAL_OBJECTS_H
#define HMG4V27_CANONICAL_OBJECTS_H

#include <stddef.h>
#include <stdint.h>

#define HMG4V27_CANONICAL_SHA256_LENGTH ((size_t)32)
#define HMG4V27_ACL_TAG_ALLOW_NAMED_UUID ((uint32_t)1)
#define HMG4V27_ACL_TAG_DENY_NAMED_UUID ((uint32_t)2)
#define HMG4V27_ACL_NAMED_UUID_LENGTH ((uint32_t)16)
#define HMG4V27_ACL_ALLOWED_PERMISSION_MASK UINT64_C(0x3fff)
#define HMG4V27_ACL_ALLOWED_FLAG_MASK UINT64_C(0x1f)
#define HMG4V27_CANONICAL_MAX_ACL_ENTRIES ((uint32_t)1024)
#define HMG4V27_XATTR_POLICY_MAX_ATTRIBUTE_COUNT ((uint32_t)64)
#define HMG4V27_XATTR_POLICY_MAX_NAME_LENGTH ((uint32_t)127)
#define HMG4V27_XATTR_POLICY_MAX_VALUE_LENGTH UINT64_C(4096)
#define HMG4V27_XATTR_POLICY_MAX_TOTAL_VALUE_LENGTH UINT64_C(65536)
#define HMG4V27_XATTR_POLICY_MAX_STREAM_LENGTH UINT64_C(524288)
...
typedef enum {
  ...
  HMG4V27_CANONICAL_HASH_FAILURE
} hmg4v27_canonical_result;
 ...
 * v2.7 bound set returned below. Tests may pass narrower bounds.
 */
typedef struct {
