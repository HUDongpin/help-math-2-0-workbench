# Grade 4 Lesson 10 native helper v2.7 production source workspace

This no-clobber directory is bound to the frozen successor security contract
and its passing Gate-A companion:

- successor SHA-256: `72b28827b7c7baff358abea33c0b919c32953ec9bcb02f4f56a7534a4f78e4cc`
- direct predecessor SHA-256: `3ce5bf0d79c003a78115be85828b0d36ca8e182e65d4329c58ba9aa3393c436a`
- root predecessor SHA-256: `77c2479d7be197e62a9cf37e05d71d6051858a29167143ca39ddc5be7b994583`
- Gate-A companion SHA-256: `cf919fe4478795140157c603348064c17b2c8c65519a2735c842759f59b68826`
...
The inherited v2.7 implementation increments are `contract_core.c/.h`,
...
`HMG4V27_TRANSPORT_TESTING` definition. The real-exec harness uses three
...
```bash
node --test scripts/g4-l10-native-helper-v2_7-contract-core.test.mjs
node --test scripts/g4-l10-native-helper-v2_7-canonical-tlv.test.mjs
node --test scripts/g4-l10-native-helper-v2_7-request-schema.test.mjs
node --test scripts/g4-l10-native-helper-v2_7-request-transport-core.test.mjs
node --test scripts/g4-l10-native-helper-v2_7-darwin-startup-fd.test.mjs
node --test scripts/g4-l10-native-helper-v2_7-canonical-objects-xattr-policy.test.mjs
node --test scripts/g4-l10-native-helper-v2_7-bundle-codec.test.mjs
node --test scripts/g4-l10-native-helper-v2_7-response-codec.test.mjs
node --test scripts/g4-l10-native-helper-v2_7-darwin-pipe-transport.test.mjs
```
