#ifndef HMG4V23_DARWIN_PIPE_TRANSPORT_TESTING_H
#define HMG4V23_DARWIN_PIPE_TRANSPORT_TESTING_H

#ifndef HMG4V23_TRANSPORT_TESTING
...
} hmg4v23_transport_test_backend;
