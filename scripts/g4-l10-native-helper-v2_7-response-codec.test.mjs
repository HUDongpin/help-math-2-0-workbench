...
async function privateRoot(label) {
  const root = await mkdtemp(path.join(tmpdir(), `hmg4v27-response-${label}-`));
...
test("HMG4R2 object has a closed symbol surface and reproducible bytes", {
  ...
  assert.deepEqual(undefinedResult.stdout.trim().split("\n").sort(), [
    "___stack_chk_fail", "___stack_chk_guard", "_hmg4v27_checked_add_size",
    "_hmg4v27_parse_custody_leaf", "_hmg4v27_range_within",
    "_hmg4v27_read_u32_be", "_hmg4v27_read_u64_be", "_hmg4v27_sha256",
    "_hmg4v27_tlv_cursor_init", "_hmg4v27_tlv_next_raw",
    "_hmg4v27_validate_diagnostic_status", "_hmg4v27_write_u16_be",
    "_hmg4v27_write_u32_be", "_hmg4v27_write_u64_be", "_memmove",
  ].sort());
