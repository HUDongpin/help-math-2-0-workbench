# Grade 4 Lesson 10 native transaction helper v2.2 successor security contract
...
This file is a non-destructive successor to the frozen v2.1 successor
`docs/G4_L10_NATIVE_HELPER_V2_1_SECURITY_CONTRACT_SUCCESSOR.md`, which remains
byte-for-byte preserved at SHA-256
`170bd54b031f1f6e693f152aef885a509b2d4328f5032cc620a41dcf49a884ab`.
That direct predecessor incorporates
...
Both predecessors are incorporated by those exact hashes. Their requirements
remain normative unless this successor expressly replaces them. On conflict,
this successor controls. Silence here never weakens either predecessor.
...
that one enumeration rule with the closed estimate/capacity/actual-count rule
in Section 2; it does not weaken the stable two-pass, exact-three-FD, pipe,
direction, handle, self-identity, custody, authority, or mutation gates.

After this file is frozen, `protocol_spec_sha256` means SHA-256 of the complete
exact bytes of this successor file. This file binds both predecessor hashes
above, so one successor hash transitively binds all three documents without a
self-hash.
