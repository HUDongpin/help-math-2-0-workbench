# course-g05-l05-ti-007 M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l05-add-subtract-negative-numbers`; member **42/57**; role: `active-xml-referenced-page`; shard: `g05-l05-practice-assessment`.
...
- Static exported scripts: **48**. This is not a complete reachable script inventory.
...
- Canonical audio-inventory data rows: **8**.
