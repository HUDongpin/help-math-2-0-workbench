# course-g05-l05-rw-004 M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l05-add-subtract-negative-numbers`; member **4/57**; role: `active-xml-referenced-page`; shard: `g05-l05-host-language`.
- Animation/asset: `course-g05-l05-rw-004` / `swf-78b003d025ef66eec5d5f9c7a0729f671067acc3286d05fb81e0930694e7fa30`.
- SWF: `source-assets/flash/HELP MATH_ORIGINAL FILES/HELP_COURSES/ELMGR5/L5/RW/L5RW04.swf`; 1321965 bytes; SHA-256 `78b003d025ef66eec5d5f9c7a0729f671067acc3286d05fb81e0930694e7fa30`.
- FLA: not present in the frozen source scope; no authoring structure is inferred.
- Source-scope role: `lesson-page`; source model: `shipped-swf-only`.
