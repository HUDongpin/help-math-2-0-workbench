# course-g05-l05-vb-006 M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l05-add-subtract-negative-numbers`; member **9/57**; role: `active-xml-referenced-page`; shard: `g05-l05-host-language`.
