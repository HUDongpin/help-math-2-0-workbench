# course-g05-l04-vb-004 Migration Brief
...
## course-g05-l04-vb-004 M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l04-number-lines`; member **7/55**; role: `active-xml-referenced-page`; shard: `g05-l04-host-language`.
...
- Static exported scripts: **43**. This is not a complete reachable script inventory.
