# keyterm-elementary-computeghgh Acceptance Checklist
...
- [x] Frame 1, all transition boundaries, text/count changes, interactions, final frame, and Replay are listed in `keyframes.csv`.
- [x] Native-size baseline images exist for every required keyframe.
- [x] Every baseline, implementation, diff, capture-manifest, metrics, asset, and audio checksum verifies.
...
- [x] Metadata and every required timeline beat have automated tests.
- [x] Language variants, boundary frames, completion, and Replay have automated tests.
