# course-g05-l05-vb-013 M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l05-add-subtract-negative-numbers`; member **16/57**; role: `active-xml-referenced-page`; shard: `g05-l05-host-language`.
...
- Static exported scripts: **34**. This is not a complete reachable script inventory.
