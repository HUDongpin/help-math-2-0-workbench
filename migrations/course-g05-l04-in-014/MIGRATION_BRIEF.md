# course-g05-l04-in-014 Migration Brief
...
## course-g05-l04-in-014 M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l04-number-lines`; member **27/55**; role: `active-xml-referenced-page`; shard: `g05-l04-instruction`.
...
- Static exported scripts: **25**. This is not a complete reachable script inventory.
