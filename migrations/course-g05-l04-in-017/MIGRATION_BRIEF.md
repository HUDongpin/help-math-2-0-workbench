# course-g05-l04-in-017 Migration Brief
...
## course-g05-l04-in-017 M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l04-number-lines`; member **30/55**; role: `active-xml-referenced-page`; shard: `g05-l04-instruction`.
...
- Static exported scripts: **42**. This is not a complete reachable script inventory.
...
- Canonical audio-inventory data rows: **14**.
