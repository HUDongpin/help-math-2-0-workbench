# course-g05-l05-ts-002 M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l05-add-subtract-negative-numbers`; member **47/57**; role: `active-xml-referenced-page`; shard: `g05-l05-practice-assessment`.
...
- Static exported scripts: **6**. This is not a complete reachable script inventory.
