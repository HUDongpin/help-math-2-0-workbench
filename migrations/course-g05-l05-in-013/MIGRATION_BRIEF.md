# course-g05-l05-in-013 M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l05-add-subtract-negative-numbers`; member **29/57**; role: `active-xml-referenced-page`; shard: `g05-l05-instruction`.
