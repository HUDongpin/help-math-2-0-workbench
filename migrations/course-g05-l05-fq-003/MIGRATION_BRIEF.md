# course-g05-l05-fq-003 M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l05-add-subtract-negative-numbers`; member **56/57**; role: `active-xml-referenced-page`; shard: `g05-l05-practice-assessment`.
- Animation/asset: `course-g05-l05-fq-003` / `swf-43c27a0b81662befa75d09fe042c0379090acee274839316d614c8d66ab0d7d2`.
- SWF: `source-assets/flash/HELP MATH_ORIGINAL FILES/HELP_COURSES/ELMGR5/L5/FQ/L5FQ03.swf`; 58043 bytes; SHA-256 `43c27a0b81662befa75d09fe042c0379090acee274839316d614c8d66ab0d7d2`.
- FLA: `source-assets/flash/HELP MATH_ORIGINAL FILES/HELP_COURSES/ELMGR5/L5/FQ/L5FQ03.fla`; 2408448 bytes; SHA-256 `2c2bff98d5594dc8ce642dce7cc38673c5b9d2d48dd5b4bdb27b8583f7bfdf38`.
...
- SWF signature/version: **CWS/7**; ActionScript generation: **AS1/2**; background: **#b8d8f7**.
- Tool versions adopted exactly from the machine audit: FFDec **JPEXS Free Flash Decompiler v.26.2.1**; swfmill **swfmill 0.3.6**.
- Static exported scripts: **123**. This is not a complete reachable script inventory.
- Static dependency API candidates: **1** APIs / **1** occurrences. No endpoint was contacted or executed.
...
- Canonical audio-inventory data rows: **0**.
