# course-g05-l05-in-012 M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l05-add-subtract-negative-numbers`; member **28/57**; role: `active-xml-referenced-page`; shard: `g05-l05-instruction`.
...
- Static exported scripts: **22**. This is not a complete reachable script inventory.
...
- Canonical audio-inventory data rows: **6**.
