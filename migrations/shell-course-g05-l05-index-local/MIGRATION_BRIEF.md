# shell-course-g05-l05-index-local M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l05-add-subtract-negative-numbers`; member **57/57**; role: `course-shell`; shard: `g05-l05-host-language`.
- Animation/asset: `shell-course-g05-l05-index-local` / `swf-5375c535f0761ae580f00eeda29c00d34d0de901239a7d2c65acf968a8290c66`.
- SWF: `source-assets/flash/HELP MATH_ORIGINAL FILES/HELP_COURSES/ELMGR5/L5/index_local.swf`; 670102 bytes; SHA-256 `5375c535f0761ae580f00eeda29c00d34d0de901239a7d2c65acf968a8290c66`.
- FLA: not present in the frozen source scope; no authoring structure is inferred.
- Source-scope role: `lesson-shell`; source model: `shipped-swf-only`.
- Owner directive receipt: `catalog/owner-authorizations/g5-l5-owner-governance-directive-intake-2026-07-29.json`; fingerprint `9d30839237db4ad0169999b1cea2617265a7f0932733b36adff53a4f5e599481`; authority is limited to machine-only M1 static work.

## Reconciled static facts

- Stage: **800 × 600**; FPS: **12**; root frames: **50**; duration: **4166.666666666667 ms**.
- SWF signature/version: **CWS/6**; ActionScript generation: **AS1/2**; background: **#ffffff**.
- Tool versions adopted exactly from the machine audit: FFDec **JPEXS Free Flash Decompiler v.26.2.1**; swfmill **swfmill 0.3.6**.
- Static exported scripts: **540**. This is not a complete reachable script inventory.
- Static dependency API candidates: **4** APIs / **14** occurrences. No endpoint was contacted or executed.
...
- Canonical audio-inventory data rows: **16**.
- Manifest audio requirement raised from false to true in this reconciliation: **true**.
