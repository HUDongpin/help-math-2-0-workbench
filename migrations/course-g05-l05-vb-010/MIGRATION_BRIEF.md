# course-g05-l05-vb-010 M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l05-add-subtract-negative-numbers`; member **13/57**; role: `active-xml-referenced-page`; shard: `g05-l05-host-language`.
...
- Static exported scripts: **31**. This is not a complete reachable script inventory.
...
- Canonical audio-inventory data rows: **3**.
