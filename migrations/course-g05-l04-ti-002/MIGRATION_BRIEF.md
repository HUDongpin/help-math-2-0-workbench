# course-g05-l04-ti-002 Migration Brief
...
## course-g05-l04-ti-002 M1 Static-Reconciled Migration Brief
...
- Release: `lesson-g05-l04-number-lines`; member **36/55**; role: `active-xml-referenced-page`; shard: `g05-l04-practice-assessment`.
...
- Static exported scripts: **61**. This is not a complete reachable script inventory.
